package com.imagine.android_imagine_tools.tools.ui.views.customAlertDialog
...
import com.imagine.android_imagine_tools.tools.databinding.DialogCustomBinding
import com.imagine.android_imagine_tools.tools.ext.gone
...
class CustomAlertDialogBuilder(private val activity: Activity) : AlertDialog.Builder(activity) {
    ...
    fun setPositiveButtonBackgroundColor(color: String): CustomAlertDialogBuilder {
        binding.customDialogPositiveMtrlButton.backgroundTintList =
    ...
    fun setNegativeButtonBackgroundColor(color: String): CustomAlertDialogBuilder {
        binding.customDialogNegativeMtrlButton.backgroundTintList =
            ColorStateList.valueOf(Color.parseColor(color))
        return this
    }
    ...
    fun setBackgroundColor(color: Int): CustomAlertDialogBuilder {
        binding.customDialogContainerConstraintLayout.background.colorFilter =
    ...
    fun setBackgroundColor(color: String): CustomAlertDialogBuilder {
        binding.customDialogContainerConstraintLayout.background.colorFilter =
            PorterDuffColorFilter(Color.parseColor(color), PorterDuff.Mode.SRC)
        return this
    }
    ...
    fun build(): AlertDialog {
        ...
        if(binding.customDialogNegativeMtrlButton.text.isNullOrEmpty()){
            binding.customDialogNegativeMtrlButton.gone()
        }

        if(binding.customDialogPositiveMtrlButton.text.isNullOrEmpty()){
            binding.customDialogPositiveMtrlButton.gone()
        }
